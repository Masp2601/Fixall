...
import 'package:fixall/profesional/code_ok.dart';
import 'package:fixall/profesional/register_page_profe.dart';
import 'package:fixall/profesional/register_profe_page.dart';
import 'package:fixall/utils/utils.dart';
import 'package:flutter/material.dart';
import 'package:pinput/pinput.dart';
import 'package:provider/provider.dart';

class NumberYapeProfePage extends StatefulWidget {
  final String verificationId;
  const NumberYapeProfePage({super.key, required this.verificationId});

  @override
  State<NumberYapeProfePage> createState() => _NumberYapeProfePageState();
}

class _NumberYapeProfePageState extends State<NumberYapeProfePage> {
  //form key
        ...
        onPressed: (() {
          if (otpCode != null) {
            ...
            Navigator.pushAndRemoveUntil(
                (context),
                MaterialPageRoute(builder: (context) => const CodePageOk()),
                (route) => false);
          } else {
          ...
          ap.checkExistingUser().then((value) async {
            if (value == true) {
              Navigator.pushAndRemoveUntil(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const RegisterPageOk()),
                  (route) => false);
            } else {
              Navigator.pushAndRemoveUntil(
                  context,
