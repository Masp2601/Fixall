...
class TarjetaDebProfePage extends StatefulWidget {
  const TarjetaDebProfePage({Key? key}) : super(key: key);

  @override
  State<TarjetaDebProfePage> createState() => _TarjetaDebProfePageState();
}
...
class _TarjetaDebProfePageState extends State<TarjetaDebProfePage> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.transparent,
        elevation: 0,
        title: const Text('Nueva Tarjeta de Debito'),
        centerTitle: true,
